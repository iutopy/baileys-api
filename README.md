...
- **[Endpoints reference](docs/API.md)** — Autenticación, base URL, tabla de endpoints, ejemplos de request/response y flujo típico. Ejemplos ejecutables en `requests.http`.
